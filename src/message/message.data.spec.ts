...
describe('MessageData', () => {
  ...
  describe('updateMessageTags', () => {
    it('successfully updated tags to a message', async () => {
      const conversationId = new ObjectID();
      const message = await messageData.create(
      ...
      // Make sure that it started off as an empty array
      ...
      const updatedEmptyTagMessage = await messageData.updateMessageTags(
        new ObjectID(message.id),
        emptyTags,
      );
